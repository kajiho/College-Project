  ...
  // Determine active section based on URL
    ...
    switch (activeSection) {
        ...
        <div className="fade-in">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Nepalgunj Campus of Management & Technology</h2>
            ...
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-8 text-white">
                ...
                <a href="/library" className="bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg p-4 transition-all duration-300 transform hover:scale-105 text-center">
                    📖 Library
                </a>
                <a href="/form" className="bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg p-4 transition-all duration-300 transform hover:scale-105 text-center">
                    📝 Forms
                </a>
                <a href="/about" className="bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg p-4 transition-all duration-300 transform hover:scale-105 text-center">
                    🎯 Courses
                </a>
                <a href="/contact" className="bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg p-4 transition-all duration-300 transform hover:scale-105 text-center">
                    📅 Events
                </a>
                </div>
            </div>
    ...
    <div className="fade-in bg-gray-700">
        ...
        onSubmit={(e) => {
            ...
            <input type="number" className="form-input" placeholder="Enter roll number" required />
            </div>
            <div>
            ...
            <input type="number" className="form-input" placeholder="Enter phone number" required />
            </div>
            <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-2">Address</label>
            <textarea className="form-input h-12" placeholder="Enter your address" required></textarea>
            </div>
            <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-2">Additional Information</label>
            <textarea className="form-input h-24" placeholder="Any additional information or queries..."></textarea>
            </div>
            <div className="md:col-span-2">
